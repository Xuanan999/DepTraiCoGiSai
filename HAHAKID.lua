    ...
    Welcome = function()
            ...
            " "
                ..
                        ...
                        Gamename.. "!" .. " Ryzen 5 Codex Team]"  .."\n Loadded Successfully Script Troll Nigga By AnDepZai"
            )
    end
}
}
...
rac.new("<cặc> aka (ThaoCuti) Admin!, send you many gifts from far away")
b(itemne,true)
...
lon.TextSize = 50
lon.Text = 'mày bị lừa rồi thằng ngu'
...
local args = {
    ...
    [1] = "report me kid gay nigga lgbt",
